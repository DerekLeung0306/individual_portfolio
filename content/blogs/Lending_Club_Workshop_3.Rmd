...
lc_raw <- read_csv("LendingClub Data.csv",  skip=1) %>%  clean_names() # use janitor::clean_names()
```
...
```{r}
CPI_df <- read_csv("CPALTT01USM657N.csv") %>%  clean_names() # use janitor::clean_names()
