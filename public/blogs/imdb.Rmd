...
- ""
date: "2020-09-20"
description: Comparing directors' average ratings using `infer` package
draft: false
image: pic10.jpg
keywords: ""
slug: imdb
...
Recall the IMDB ratings data. I would like to explore whether the mean IMDB rating for Steven Spielberg and Tim Burton are the same or not.

I now load the data and examine its structure.

```{r load-movies-data}
movies <- read_csv("/Users/dl/Documents/MAM/individual_portfolio/data/movies.csv")
glimpse(movies)
```
...
data201<-movies%>%
  ...
  group_by(director)%>%
  #basic statistics for calculating confidence intervals
...
H0: mean_steven=mean_tim, H1: mean_steven!=mean_tim (Note != means "not equal to")
